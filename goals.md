...
## Plan
1. Strengthen current JavaScript skill by learning ES6 features
2. Fill knowledge gap of CSS3
3. Refresher on Package Managers
4. Learn about CSS Preprocessors
5. Learn BEM CSS Architecture
6. Learn Build Tools (Webpack, ESLint, NPM Scripts)
7. Pick framework and build application using it
